      ...
      <div className="relative z-10 flex items-center justify-center h-full px-4 md:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-6 md:space-y-8 animate-fade-in">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg tracking-tight">
            <span className="block text-red-500">Nutrition & Wellbeing</span>
            <span className="block mt-2">in Mining Villages</span>
          </h1>
          <p className="text-white/90 text-lg md:text-xl font-medium leading-relaxed drop-shadow-md">
            We enhance nutrition and wellbeing in mining villages through community health programs, access to nutritious food, and initiatives that promote physical and mental wellness for a healthier, stronger future.
          </p>
          <a
            href="#learn-more"
...
export default BannerNutrition;
