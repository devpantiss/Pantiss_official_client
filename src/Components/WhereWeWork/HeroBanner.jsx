...
const states = [
  { name: "Odisha", position: [20.9517, 85.0985], path: "/where-we-work/odisha", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737363056/puri-tour-2022_rehrwx.jpg" },
  { name: "Jharkhand", position: [23.6102, 85.2799], path: "/where-we-work/jharkhand", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1735376736/vladimir-patkachakov-Mx6Xmf_nbRk-unsplash_ej5umt.jpg" },
  { name: "Chhattisgarh", position: [21.2787, 81.8661], path: "/where-we-work/chhattisgarh", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737364380/Chattisgarh_zoaot8.jpg" },
  { name: "Tamil Nadu", position: [11.1271, 78.6569], path: "/where-we-work/tamil-nadu", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737364635/tamilnadu_vd888x.jpg" },
  { name: "Assam", position: [26.2447, 92.5376], path: "/where-we-work/assam", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737364708/mohamed-abdul-rasheed-En_YGRzonpE-unsplash_epgixj.jpg" },
];

const districts = {
  Odisha: [
    { name: "Anugul", position: [20.8371, 85.1511], path: "/where-we-work/odisha/anugul", image: "https://media-cdn.tripadvisor.com/media/photo-s/08/42/ff/85/satkosia-gorge-wildlife.jpg" },
    { name: "Jajapur", position: [20.8504, 86.3377], path: "/where-we-work/odisha/jajapur", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1738227984/jajapur_kq8q03.jpg" },
    { name: "Jharsuguda", position: [21.8554, 84.0062], path: "/where-we-work/odisha/jharsuguda", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1738228112/jharsuguda_b6v2ll.jpg" },
    { name: "Sundargarh", position: [22.12, 84.0372], path: "/where-we-work/odisha/sundargarh", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737396691/Screenshot_2025-01-20_at_11.41.03_PM_zx7pts.png" },
    { name: "Keonjhar", position: [21.5, 85.5], path: "/where-we-work/odisha/keonjhar", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737396135/Bhimkund-Keonjhar-Side-2-1024x676_exicvm.jpg" },
    { name: "Kalahandi", position: [19.9014, 83.1649], path: "/where-we-work/odisha/kalahandi", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1738228210/kalahandi_hobe6n.jpg" },
  ],
  Jharkhand: [
    { name: "Bokaro", position: [23.6693, 86.1511], path: "/where-we-work/jharkhand/bokaro", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737445215/bokaro_bbtz81.jpg" },
    { name: "Koderma", position: [24.4692, 85.5932], path: "/where-we-work/jharkhand/koderma", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737445180/koderma2_txdz5o.jpg" },
    { name: "Dhanbad", position: [23.7957, 86.4304], path: "/where-we-work/jharkhand/dhanbad", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737445286/dhanbad_wbmxrl.jpg" },
  ],
  Assam: [
    { name: "Guwahati", position: [26.1445, 91.7362], path: "/where-we-work/assam/guwati", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737450493/TNIE_import_2023_3_6_original_Illegalcoalmining_cthtx2.avif" },
    { name: "Dispur", position: [26.1402, 91.788], path: "/where-we-work/assam/dispur", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737450575/mining_kg3nig.jpg" },
  ],
  "Tamil Nadu": [
    { name: "Neyveli", position: [11.601, 79.4882], path: "/where-we-work/tamil-nadu/neyveli", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1737443051/Chennai_vkkosd.jpg" },
  ],
  Chhattisgarh: [
    { name: "Korba", position: [22.3595, 82.7501], path: "/where-we-work/Chhattisgarh/korba", image: "https://res.cloudinary.com/dgtc2fvgu/image/upload/v1738228494/korba_wraof6.webp" },
  ],
};
...
const latestNews = {
  ...
  Jharkhand: [
    { 
      ...
      description: "Jharkhand’s Recognition of Prior Learning (RPL) program has emerged as a game-changer for the state’s mining workforce. Targeting experienced but uncertified miners, the initiative has certified over 800 workers in its initial phase, providing them with formal qualifications in mining operations, safety standards, and machinery maintenance. This upskilling effort is enhancing employability, improving workplace safety, and aligning the workforce with modern industry demands.",
...
const impactData = {
  Odisha: {
    description: "Odisha has impacted over 50,000 families with clean energy solutions and sustainable farming projects.",
    stats: [
  ...
  Jharkhand: {
    description: "Bihar has transformed its rural areas with modern infrastructure and clean water initiatives.",
    stats: [
  ...
  Assam: {
    description: "West Bengal has strengthened its economy through trade and renewable energy projects.",
    stats: [
  ...
  "Tamil Nadu": {
    description: "Jharkhand has achieved milestones in mining safety and green energy development.",
    stats: [
  ...
  Chhattisgarh: {
    description: "Chhattisgarh has pioneered rural education and sustainable development projects.",
    stats: [
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      {selectedState && (
        <div className="mt-8 w-full">
          ...
          <Heading text="WHERE WE WORK!" color="text-black" bgColor="bg-red-600" />
          </div>
