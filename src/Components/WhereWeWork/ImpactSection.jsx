...
const ImpactSection = ({ impact }) => {
  return (
    <div
      className="pb-6 bg-[url('https://res.cloudinary.com/dxzhnns58/image/upload/v1761810820/martha-nq0DX-VD3gA-unsplash_nufyxf.jpg')] bg-cover bg-center bg-fixed relative"
