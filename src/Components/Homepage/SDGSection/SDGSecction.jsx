...
const SDGSectionLogo = () => {
  return (
    <div className="relative w-64 h-64 flex justify-center items-center bg-transparent">
      ...
      <div className="relative">
        <img
          ...
          alt="Rotating Logo"
          className="w-64 h-64 animate-rotate"
        />
      </div>

      {/* White semicircle overlay */}
      <div className="absolute top-30 bottom-0 left-0 right-0 flex justify-center items-center">
        <div className="relative w-64 h-32 bg-white rounded-b-full overflow-hidden z-10">
