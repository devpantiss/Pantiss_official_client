...
const SDGSectionLogo = () => {
  return (
    <div className="relative w-48 h-48 flex justify-center items-center bg-transparent">
      ...
      <div className="absolute top-30 bottom-0 left-0 right-0 flex justify-center items-center">
        <div className="relative w-48 h-24 bg-white rounded-b-full overflow-hidden z-10">
