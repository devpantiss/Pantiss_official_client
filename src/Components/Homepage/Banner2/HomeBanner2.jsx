    ...
    <div className="relative w-full h-screen overflow-hidden pt-32">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-black/30 flex items-center justify-center">
        <div className="text-center text-white ">
          <h1 className="relative text-4xl md:text-6xl font-bold mb-4">Welcome to Pantiss Responsible Mining! <img className='absolute -top-4 lg:-top-3 w-10 lg:right-[55%] right-[43%]' src="https://res.cloudinary.com/dgtc2fvgu/image/upload/v1726395483/leaf_n7rkfr.png" alt='leaf'/></h1>
