...
const ProgrammeSection = () => {
  ...
  return (
    <section className="py-16 black-shade-gradient">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row-reverse lg:items-center lg:justify-between">
          {/* Heading (Aligned Right with Animation) */}
          <div className="lg:w-1/2 mb-8 lg:mb-0 fade-in-from-left text-right">
            ...
            <Link
              to="/news"
              className="mt-4 inline-block text-white hover:text-gray-200 font-semibold text-sm uppercase transition-colors duration-300"
          ...
          {/* Slider (Aligned Left with Animation) */}
          <div className="lg:w-1/2 fade-in-from-right relative">
            {/* Previous Button */}
            <button
        ...
        <style>{`
          /* Moving Gradient Background with Shades of Black */
          .black-shade-gradient {
            background: linear-gradient(
              90deg,
              #1f1f1f 0%, /* Dark black */
              #4b4b4b 25%, /* Medium gray-black */
              #2d2d2d 50%, /* Slightly lighter black */
              #4b4b4b 75%, /* Medium gray-black */
              #1f1f1f 100% /* Dark black */
            );
